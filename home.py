...
def home_screen():
    ...
    st.markdown(
        ...
        <p style="font-size: 1.1rem; line-height: 1.7;">
            수학적 사고가 실현되는 공간, 숭고 수학 스튜디오에 오신 것을 환영합니다.<br>
            **'미적분'**의 동적인 변화와 **'인공지능 수학'**의 핵심 원리를 직접 시각화하며 탐구할 수 있도록 설계되었습니다.<br>
            교과별 탐구 활동부터 효율적인 수행평가 안내, 스마트한 좌석 관리까지—수업의 몰입도를 높이는 수학적 도구들을 지금 바로 경험해 보세요.<br>
